...
@TableName("`monad_last_instance`")
public class MonadLastInstance extends Model<MonadLastInstance> {
    ...
    @TableField(value = "`main_issues`")
    @ApiModelProperty(value = "稿件中尚存在的主要问题")
    private String mainIssues;

    @TableField(value = "`suggestions_and_measures`")
