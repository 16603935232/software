...
@TableName("`predict_indicators_publish`")
public class PredictIndicatorsPublish extends Model<PredictIndicatorsPublish> {
    ...
    @ApiModelProperty(value = "二级指标，0观测指数，1特征指数，2难题指数")
