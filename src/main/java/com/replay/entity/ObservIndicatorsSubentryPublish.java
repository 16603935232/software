...
@TableName("`observ_indicators_subentry_publish`")
public class ObservIndicatorsSubentryPublish extends Model<ObservIndicatorsSubentryPublish> {
    ...
    @TableField(value = "`observ_id`")
    @ApiModelProperty(value = "观测ID")
    private Long observId;
