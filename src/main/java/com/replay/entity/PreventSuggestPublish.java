...
@TableName("`prevent_suggest_publish`")
public class PreventSuggestPublish extends Model<PreventSuggestPublish> {
    ...
    @TableField(value = "`expert_department`")
    @ApiModelProperty(value = "专家单位")
    private String expertDepartment;

    @TableField(value = "`expert_position`")
    ...
    @TableField(value = "`expert_score`")
    @ApiModelProperty(value = "专家打分")
    private BigDecimal expertScore;

    @TableField(value = "`expert_opinion`")
